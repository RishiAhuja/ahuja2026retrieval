def print_args(args):
    ...
    if args.task_name in ['long_term_forecast', 'short_term_forecast']:
        ...
        print(f'  {"Pred Len:":<20}{args.pred_len:<20}{"Seasonal Patterns:":<20}{getattr(args, "seasonal_patterns", "N/A"):<20}')
    ...
    print(f'  {"Activation:":<20}{args.activation:<20}{"Output Attention:":<20}{getattr(args, "output_attention", False):<20}')
    print()
    ...
    print(f'  {"Learning Rate:":<20}{args.learning_rate:<20}{"Loss:":<20}{args.loss:<20}')
