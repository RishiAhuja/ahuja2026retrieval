#!/usr/bin/env python3
"""
MEMORY-OPTIMIZED: PatchTST 3000 on ETTh2
========================================
Run ONLY the PatchTST 3000 experiment with aggressive memory cleanup
This is the critical degradation proof experiment.
...
def create_args():
    """Create args for PatchTST 3000"""
    class Args:
        def __init__(self):
            # Dataset configuration - ETTh2
            self.data = 'ETTh2'
            ...
            # Prediction setup
            self.seq_len = 3000  # LONG CONTEXT
            self.label_len = 48
            self.pred_len = 96
            ...
            # Training - REDUCED batch size for memory
            self.train_epochs = 10
            self.batch_size = 16  # Reduced from 32 to save memory
            self.patience = 3
            ...
            self.des = 'ETTh2_validation_PatchTST_3000'
            self.task_name = 'long_term_forecast'
            self.is_training = 1
            self.model_id = 'ETTh2_PatchTST_3000'
            self.itr = 1
...
def main():
    print("\n" + "=" * 80)
    print("⚠️  MEMORY-OPTIMIZED EXPERIMENT: PatchTST 3000 on ETTh2")
    print("=" * 80)
    print("\n🎯 This is the CRITICAL degradation proof experiment")
    print("   Comparing with PatchTST 720 MSE: 0.3073")
    print()
    ...
    # Training
    print("\n📚 Training PatchTST with 3000 context length...")
    print("   (This will test if long context degrades performance)")
    setting = 'ETTh2_validation_PatchTST_3000'
    ...
    try:
        ...
        mse_720 = 0.3073  # From ETTh2 results
        degradation_pct = ((mse - mse_720) / mse_720) * 100
        
        result = {
            "experiment": "ETTh2 - PatchTST (3000) - Degradation Proof",
            "dataset": "ETTh2",
            "model": "PatchTST",
            "seq_len": 3000,
            "d_model": 128,
        ...
        result_file = './experiments/results/patchtst_3000_etth2.json'
        ...
        if degradation_pct > 10:
            print("   ✅ CONFIRMED: Long context degrades performance!")
            print("      → Hypothesis validated on ETTh2")
            ...
            print("      → Hypothesis not confirmed on ETTh2")
        ...
        if "out of memory" in str(e):
            ...
            print("   2. Reduce batch_size further (currently 16)")
            print("   3. Reduce d_model or e_layers")
            print(f"\nError: {e}")
        else:
            raise
