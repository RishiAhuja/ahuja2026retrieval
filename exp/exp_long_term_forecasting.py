...
class Exp_Long_Term_Forecast(Exp_Basic):
    """Experiment runner for RAFT and PatchTST long-term forecasting."""
    ...
    def _build_model(self):
        ...
        # RAFT requires pre-computed retrieval indices from training data
    ...
    def test(self, setting, test=0):
        ...
        # DTW metric (optional, time-consuming)
